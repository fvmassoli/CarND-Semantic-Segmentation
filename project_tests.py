...
def test_load_vgg(load_vgg, tf_module):
    with TmpMock(tf_module.saved_model.loader, 'load') as mock_load_model:
        ...
        input_image, keep_prob, vgg_layer3_out, vgg_layer4_out, vgg_layer7_out = load_vgg(sess, vgg_path, False)
...
def test_layers(layers):
    ...
    layers_output = layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes, False)
